...
public class RNTesterTargetActivity extends ReactActivity {
  public static class RNTesterActivityDelegate extends ReactActivityDelegate {
    ...
    public RNTesterActivityDelegate(ReactActivity activity, String bundleName, String mainComponentName) {
      super(activity, bundleName, mainComponentName);
  ...
  protected String getBundleName() {
    Log.i("multi-bundle", "getBundleName: RNTesterApp.android.bundle");
